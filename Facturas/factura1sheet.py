...
tabla_cabecera.setStyle([
    # Estilo para centrar la cabecera en su celda
    ('ALIGN', (0, 0), (0, 0), 'CENTER'),
    # Estilo para alinear la imagen a la derecha de su celda
    ('ALIGN', (1, 0), (1, 0), 'RIGHT')
])
...
doc=SimpleDocTemplate("Factura1sheet.pdf", pagesize=A4)
