...
imagenes =[]
imagen = Image(0,0,300,281, "JorgeAmestoy.jpg")# Insertar imagen en el pdf
dibujo = Drawing()# Puedo darle el temaño dentro de los parentesis
...
renderPDF.drawToFile(dibujo, "ejemplosImageRpl.pdf", "Imagenes")# Esto es para que se renderize el documento pdf y se guarde con el nombre "imagenes.pdf" y el titulo "Imagenes"